...
Frozen dated ADRs. Never edited after commit — supersession is a new dated
file with a forward link; the sole exception is path-only link fixes. Line 1
of every ADR is a status banner: `Status: frozen` or
`Status: superseded by [link]`. Template: [0000-template.md](./0000-template.md).
