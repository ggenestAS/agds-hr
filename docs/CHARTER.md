...
| Transactional outbox / `id_map` / legacy bridge            | an external system must observe writes / a legacy system appears | trigger fired — Resend observes writes; `notifications.outbox` shipped (ADR 2026-07-04) |
